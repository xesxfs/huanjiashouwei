package
{
   ...
   public class §_-JZ§ extends MovieClip
   {
      ...
      public function §_-JZ§(param1:int, param2:Enemy, param3:Point = null, param4:§_-27§ = null, param5:int = 0, param6:Boolean = false, param7:int = 0, param8:int = 0)
      {
         super();
