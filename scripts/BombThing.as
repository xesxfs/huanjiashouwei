package
{
   ...
   public class BombThing extends MovieClip
   {
      ...
      public function BombThing(param1:Point, param2:Point)
      {
         super();
      ...
      {
         this.minDamage = this.cRoot.gameSettings.enemies.theThing.bombMinDamage;
         this.maxDamage = this.cRoot.gameSettings.enemies.theThing.bombMaxDamage;
      }
