package
{
   ...
   public class §_-DP§ extends MovieClip
   {
      ...
      public function §_-DP§(param1:Point, param2:int, param3:Level)
      {
         super();
         ...
         this.y = param1.y;
         this.level = param2;
         this.maxProjectiles = param2 * this.cRoot.gameSettings.heroes.heroMage.thunderProjectilesPerLevel;
         this.spawnTime = 6;
         this.§_-T3§ = 0;
         this.fadeTime = 24;
      ...
      protected function §_-9v§() : void
      {
         ...
         this.cRoot.entities.addChild(new §_-ST§(this.getThunderDestination(this.§_-T3§,_loc1_,_loc2_),this.level,this.cRoot));
      ...
      protected function getThunderDestination(param1:int, param2:int, param3:int) : Point
      {
