package
{
   ...
   public class PortalTwo extends Portal
   {
       
      
      private var group:int;
      
      public function PortalTwo(param1:Point, param2:int, param3:int, param4:EnemyVeznan)
      {
      ...
      override protected function init(param1:Event) : void
      {
         ...
         {
            this.group = 1;
            this.enemiesTotalMax = this.enemiesSpawnMax = this.getRandom(2,4);
         }
         else if(_loc2_ > 0.5 && _loc2_ <= 0.8)
         {
            this.group = 2;
            this.enemiesTotalMax = this.enemiesSpawnMax = 2;
         }
         else
         {
            this.group = 3;
