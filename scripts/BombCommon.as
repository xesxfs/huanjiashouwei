package
{
   ...
   public class BombCommon extends Bomb
   {
       
      
      public function BombCommon(param1:int, param2:Point, param3:Point)
      {
      ...
      {
         this.§_-Fi§ = this.cRoot.gameSettings.engineers.level1.area;
         this.minDamage = this.cRoot.gameSettings.engineers.level1.minDamage;
         this.maxDamage = this.cRoot.gameSettings.engineers.level1.maxDamage;
      }
