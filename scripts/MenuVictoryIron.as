package
{
   ...
   public class MenuVictoryIron extends MovieClip
   {
      ...
      public function MenuVictoryIron(param1:Level)
      {
         super();
      ...
      public function eFrameEvents(param1:Event) : void
      {
         ...
         if(this.§_-9j§ >= this.§_-Ke§)
         {
            ...
            {
               this.cRoot.data.ironModeCurrent = true;
               if(!this.cRoot.data.ironModeWin)
               {
                  this.cRoot.game.stars = this.cRoot.game.stars + 1;
                  this.cRoot.game.starsWon = this.cRoot.game.starsWon + 1;
                  this.cRoot.data.ironModeRecently = true;
               }
               else
               {
                  this.cRoot.data.ironModeRecently = false;
               }
               this.cRoot.data.ironModeWin = true;
               if(this.cRoot.data.ironDifficulty != GameSettings.DIFFICULTY_NORMAL)
               {
                  this.cRoot.data.ironDifficulty = this.cRoot.game.difficulty;
               }
               this.cRoot.data.win();
