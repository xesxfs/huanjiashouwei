package
{
   ...
   public class BombBfg extends Bomb
   {
       
      
      public function BombBfg(param1:int, param2:Point, param3:Point)
      {
      ...
      override protected function init(param1:Event) : void
      {
         ...
         this.t0 = 0;
         this.t1 = 30;
         this.§_-Fi§ = this.cRoot.gameSettings.engineers.bfg.area;
         this.minDamage = this.cRoot.gameSettings.engineers.bfg.minDamage;
         this.maxDamage = this.cRoot.gameSettings.engineers.bfg.maxDamage;
