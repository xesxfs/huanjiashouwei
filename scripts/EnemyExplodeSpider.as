package
{
   ...
   public class EnemyExplodeSpider extends MovieClip
   {
      ...
      public function EnemyExplodeSpider(param1:Point, param2:Level)
      {
         super();
         ...
         param2.addToDecal(new §_-Oz§(new Point(this.x,this.y)));
      }
