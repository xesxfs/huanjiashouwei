package
{
   ...
   public class §_-QD§ extends MovieClip
   {
      ...
      public function §_-QD§(param1:Level, param2:Boolean = true)
      {
         super();
         this.cRoot = param1;
         this.x = 625;
         ...
         this.addEventListener(MouseEvent.CLICK,this.pause,false,0,true);
      ...
      protected function pause(param1:MouseEvent) : void
      {
      ...
      public function destroyThis() : void
      {
         ...
         this.§_-0h§ = null;
         this.cRoot = null;
         this.removeEventListener(MouseEvent.CLICK,this.pause);
