package
{
   ...
   public class PowerPointerReinforcementLevel2 extends §_-Tm§
   {
       
      
      public function PowerPointerReinforcementLevel2(param1:Level, param2:§_-5g§)
      {
      ...
      private function getRandomFarmer(param1:int, param2:int) : Soldier
      {
         ...
         if(_loc3_ < 0.33)
         {
            return new SoldierReinforcementLevel2A(new Point(this.x + param1,this.y + param2),new Point(this.x + param1,this.y + param2),null,new Point(this.x,this.y));
         }
         if(_loc3_ >= 0.33 && _loc3_ <= 0.66)
         {
            return new SoldierReinforcementLevel2B(new Point(this.x + param1,this.y + param2),new Point(this.x + param1,this.y + param2),null,new Point(this.x,this.y));
         }
         return new SoldierReinforcementLevel2C(new Point(this.x + param1,this.y + param2),new Point(this.x + param1,this.y + param2),null,new Point(this.x,this.y));
      }
