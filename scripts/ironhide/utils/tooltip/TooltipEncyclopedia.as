package ironhide.utils.tooltip
{
   ...
   public class TooltipEncyclopedia extends Tooltip
   {
      ...
      private var menuEncyclopedia:MenuEncyclopedia;
      ...
      public function TooltipEncyclopedia(param1:MenuEncyclopedia, param2:Point, param3:Point)
      {
         this.pFormat = new TextFormat();
         this.hFormat = new TextFormat();
         super(param2,param3,true);
         this.menuEncyclopedia = param1;
         this.addChildAt(tFill,0);
         this.__setStr_h1_TooltipEncyclopedia_h1_0();
      }
      ...
      {
         this.menuEncyclopedia.moveTooltip(this.side);
      }
      ...
      override public function positionToolTip() : *
      {
         ...
         if(this.x + this.menuEncyclopedia.x + this.margin + this.tFill.width > stage.stageWidth)
         {
         ...
         if(this.y + this.menuEncyclopedia.y - this.margin - this.tFill.height < stage.y)
         {
      ...
      function __setStr_h1_TooltipEncyclopedia_h1_0() : *
      {
         if(this.h1 == null)
         {
