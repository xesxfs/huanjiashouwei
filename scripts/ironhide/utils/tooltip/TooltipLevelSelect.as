package ironhide.utils.tooltip
{
   ...
   public class TooltipLevelSelect extends Tooltip
   {
      ...
      public function TooltipLevelSelect(param1:LevelSelect, param2:Point, param3:Point)
      {
         ...
         this.__setStr_h1_TooltipLevelSelect_h1_0();
      }
      ...
      {
         this.levelSelect.moveTooltip(this.side);
      }
      ...
      override public function positionToolTip() : *
      {
         ...
         if(this.x + this.levelSelect.x + this.margin + this.tFill.width > stage.stageWidth)
         {
         ...
         if(this.y + this.levelSelect.y - this.margin - this.tFill.height < stage.y)
         {
      ...
      function __setStr_h1_TooltipLevelSelect_h1_0() : *
      {
         if(this.h1 == null)
         {
