package ironhide.utils.tooltip
{
   ...
   public class TooltipUpgrade extends Tooltip
   {
      ...
      private var menuUpgrades:MenuUpgrades;
      ...
      public function TooltipUpgrade(param1:MenuUpgrades, param2:Point, param3:Point)
      {
         ...
         this.__setStr_h1_TooltipUpgrade_h1_0();
      }
      ...
      {
         this.menuUpgrades.moveTooltip(this.side);
      }
      ...
      override protected function init(param1:Event) : void
      {
         ...
         this.star.x = this.stars.x - 20;
         this.h1.y = this.tFill.y + this.padding;
         this.p.y = this.h1.y + this.h1.height - 2;
         this.stars.y = this.tFill.y + 8;
         this.star.y = this.stars.y;
      ...
      override public function positionToolTip() : *
      {
         ...
         if(this.x + this.menuUpgrades.x + this.margin + this.tFill.width > stage.stageWidth)
         {
         ...
         if(this.y + this.menuUpgrades.y - this.margin - this.tFill.height < stage.y)
         {
      ...
      function __setStr_h1_TooltipUpgrade_h1_0() : *
      {
         if(this.h1 == null)
         {
