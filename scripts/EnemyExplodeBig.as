package
{
   ...
   public class EnemyExplodeBig extends MovieClip
   {
      ...
      public function EnemyExplodeBig(param1:Point, param2:Level)
      {
         super();
         ...
         param2.addToDecal(new BloodDecal(new Point(this.x,this.y)));
      }
