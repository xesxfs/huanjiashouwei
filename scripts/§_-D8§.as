package
{
   ...
   public class §_-D8§ extends MovieClip
   {
      ...
      public function §_-D8§(param1:Point, param2:Soldier, param3:Point = null, param4:int = 1)
      {
         super();
      ...
      {
         this.minDamage = this.cRoot.gameSettings.enemies.raider.bombMinDamage;
         this.maxDamage = this.cRoot.gameSettings.enemies.raider.bombMaxDamage;
      }
      
      private function §_-NM§() : void
      {
         this.cRoot.decals.addChild(new §_-7s§(new Point(this.x,this.y),this.§_-Tg§));
         this.destroyThis();
      }
