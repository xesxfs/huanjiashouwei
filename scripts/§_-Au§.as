package
{
   ...
   public class §_-Au§ extends §_-Tm§
   {
       
      
      public function §_-Au§(param1:Level, param2:§_-5g§)
      {
      ...
      {
         this.cRoot.entities.addChild(this.getKnight(7));
         this.cRoot.entities.addChild(this.getKnight(-7));
      }
      
      private function getKnight(param1:int) : Soldier
      {
         return new §_-OQ§(new Point(this.x - param1,this.y - param1),new Point(this.x - param1,this.y - param1),null,new Point(this.x,this.y));
      }
