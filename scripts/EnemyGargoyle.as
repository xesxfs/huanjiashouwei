package
{
   ...
   public class EnemyGargoyle extends EnemyCommon
   {
      ...
      public function EnemyGargoyle(param1:int, param2:Array)
      {
      ...
      override public function init(param1:Event) : void
      {
         ...
         this.isFlying = this.cRoot.gameSettings.enemies.gargoyle.isFlying;
         if(this.isFlying)
         {
            this.canBeBlocked = false;
         }
         this.size = this.cRoot.gameSettings.enemies.gargoyle.size;
         this.health = this.initHealth = this.cRoot.gameSettings.enemies.gargoyle.health;
         this.speed = this.cRoot.gameSettings.enemies.gargoyle.speed;
         this.armor = this.cRoot.gameSettings.enemies.gargoyle.armor;
         this.magicArmor = this.cRoot.gameSettings.enemies.gargoyle.magicArmor;
         this.dodge = this.cRoot.gameSettings.enemies.gargoyle.dodge;
         this.gold = this.cRoot.gameSettings.enemies.gargoyle.gold;
         this.cost = this.cRoot.gameSettings.enemies.gargoyle.cost;
         this.minDamage = this.cRoot.gameSettings.enemies.gargoyle.minDamage;
         this.maxDamage = this.cRoot.gameSettings.enemies.gargoyle.maxDamage;
         this.attackReloadTime = this.cRoot.gameSettings.enemies.gargoyle.attackReloadTime - this.attackChargeTime;
         this.xSoldierAdjust = this.cRoot.gameSettings.enemies.gargoyle.xSoldierAdjust;
         this.xAdjust = this.cRoot.gameSettings.enemies.gargoyle.xAdjust;
         this.yAdjust = this.cRoot.gameSettings.enemies.gargoyle.yAdjust;
         this.nodeMarginError = this.cRoot.gameSettings.enemies.gargoyle.speed + 0.1;
         this.§_-Jc§ = new §_-H8§(new Point(0,-60),this.health,this.initHealth);
         this.addChild(§_-Jc§);
         this.§_-R2§ = "";
         this.getFacing();
         this.§_-NA§ = 23;
      ...
      {
         param1.tIconName = "gargoyle";
         param1.eName = Locale.loadStringEx("ENEMY_GARGOYLE_NAME",Locale.getDefaultLang());
      }
