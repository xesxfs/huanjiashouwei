package
{
   ...
   public class §_-H3§ extends MovieClip
   {
      ...
      public function §_-H3§(param1:Point, param2:int, param3:Point)
      {
         super();
         this.x = param1.x;
         this.y = param1.y;
      ...
      public function init(param1:Event) : void
      {
         ...
         this.cRoot.game.gameSounds.§_-9s§();
         this.§_-FC§ = this.x;
         this.§_-Qu§ = this.y;
      ...
      {
         this.cRoot.decals.addChild(new §_-7A§(new Point(this.x,this.y),this.level,this.cRoot));
         this.destroyThis();
      }
