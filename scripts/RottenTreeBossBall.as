package
{
   ...
   public class RottenTreeBossBall extends MovieClip
   {
      ...
      public function RottenTreeBossBall(param1:Point, param2:Point)
      {
         super();
         ...
         this.§_-6v§ = param2.x;
         this.§_-5M§ = param2.y;
         var _loc3_:Number = Point.distance(new Point(this.x,this.y),new Point(this.§_-6v§,this.§_-5M§));
         this.t1 = 20 + Math.floor(_loc3_ / 14);
         this.size = 80;
      ...
      {
         this.minDamage = this.cRoot.gameSettings.enemies.rottenBoss.bombMinDamage;
         this.maxDamage = this.cRoot.gameSettings.enemies.rottenBoss.bombMaxDamage;
      }
