package
{
   ...
   public class Spear extends MovieClip
   {
      ...
      public function Spear(param1:int, param2:Enemy, param3:Point = null, param4:§_-27§ = null, param5:int = 0, param6:Boolean = false, param7:int = 0)
      {
         super();
      ...
      {
         this.minDamage = this.cRoot.gameSettings.powers.reinforcementLevel4.spearMinDamage;
         this.maxDamage = this.cRoot.gameSettings.powers.reinforcementLevel4.spearMaxDamage;
      }
      
      private function §_-NM§() : void
      {
         this.cRoot.decals.addChild(new SpearDecal(new Point(this.x,this.y)));
         this.destroyThis();
      }
