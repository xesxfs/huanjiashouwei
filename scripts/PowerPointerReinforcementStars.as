package
{
   ...
   public class PowerPointerReinforcementStars extends §_-Tm§
   {
       
      
      public function PowerPointerReinforcementStars(param1:Level, param2:§_-5g§)
      {
      ...
      private function getRandomFarmer(param1:int, param2:int) : Soldier
      {
         ...
         if(_loc3_ < 0.33)
         {
            return new §_-Hy§(new Point(this.x + param1,this.y + param2),new Point(this.x + param1,this.y + param2),null,new Point(this.x,this.y));
         }
         if(_loc3_ >= 0.33 && _loc3_ <= 0.64)
         {
            return new §_-Db§(new Point(this.x + param1,this.y + param2),new Point(this.x + param1,this.y + param2),null,new Point(this.x,this.y));
         }
         if(_loc3_ >= 0.65 && _loc3_ <= 0.95)
         {
            return new §_-y§(new Point(this.x + param1,this.y + param2),new Point(this.x + param1,this.y + param2),null,new Point(this.x,this.y));
         }
         return new §_-9X§(new Point(this.x + param1,this.y + param2),new Point(this.x + param1,this.y + param2),null,new Point(this.x,this.y));
      }
