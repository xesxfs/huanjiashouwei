package
{
   ...
   public class Arrow extends MovieClip
   {
      ...
      public function Arrow(param1:int, param2:Enemy, param3:Point = null, param4:§_-27§ = null, param5:int = 0, param6:Boolean = false, param7:int = 0)
      {
         super();
      ...
      private function setLevelSettings() : void
      {
         ...
         {
            case 1:
               this.minDamage = this.cRoot.gameSettings.archers.level1.minDamage;
               this.maxDamage = this.cRoot.gameSettings.archers.level1.maxDamage;
               break;
            case 2:
               this.minDamage = this.cRoot.gameSettings.archers.level2.minDamage;
               this.maxDamage = this.cRoot.gameSettings.archers.level2.maxDamage;
               break;
            case 3:
               this.minDamage = this.cRoot.gameSettings.archers.level3.minDamage;
               this.maxDamage = this.cRoot.gameSettings.archers.level3.maxDamage;
               break;
            case 4:
               this.minDamage = this.cRoot.gameSettings.archers.ranger.minDamage;
               this.maxDamage = this.cRoot.gameSettings.archers.ranger.maxDamage;
               break;
            case 5:
               this.minDamage = this.cRoot.gameSettings.specials.elves.arrowMinDamage;
               this.maxDamage = this.cRoot.gameSettings.specials.elves.arrowMaxDamage;
         }
      }
